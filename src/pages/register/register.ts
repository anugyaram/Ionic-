  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    ...
    private formBuilder: FormBuilder) {
      ...
      this.registerForm = this.formBuilder.group({
        ...
        username:  ['', [Validators.required, Validators.minLength(5),Validators.minLength(25)]],
        password:  ['', [Validators.required, Validators.minLength(8),Validators.minLength(25)]],
